        ...
        <Card className="border-2 border-primary shadow-xl bg-card print:shadow-none">
          <CardHeader className="bg-gradient-to-r from-primary to-secondary text-primary-foreground">
            <div className="text-center">
              <CardTitle className="text-2xl mb-2">MediLink+ OP Card</CardTitle>
          ...
          <CardContent className="p-8 space-y-6">
            ...
            <div className="bg-primary/5 p-4 rounded-lg">
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">Important:</strong> Please carry this OP card along with a valid ID proof 
                during your visit. Arrive 15 minutes before your scheduled appointment.
              </p>
            </div>
          </CardContent>
        </Card>
