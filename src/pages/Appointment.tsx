...
const Appointment = () => {
  ...
  const doctor = id ? doctors.find(d => d.id === parseInt(id)) : null;
          ...
          <Card className="border-border bg-card">
            <CardHeader>
              ...
              <CardDescription className="text-muted-foreground">
                {doctor ? `Fill in your details to confirm your appointment with ${doctor.name}` : 'Fill in your details to book an appointment'}
              </CardDescription>
            </CardHeader>
